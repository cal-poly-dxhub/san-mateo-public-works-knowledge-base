...
def sync_lessons_to_vectors(bucket_name: str, project_name: str, project_type: str):
    """
    ...
    try:
        ...
        for i, lesson in enumerate(lessons):
            try:
                ...
                logger.info(f"Added lesson vector {i+1}/{len(lessons)} for {project_name}")
...
def delete_lesson_vectors(vector_bucket: str, index_name: str, project_name: str):
