...
def handler(event, context):
    ...
    try:
        ...
        if '/metadata' in path and method == 'PUT':
            ...
            return update_task(project_name, task_id, completed_date, projected_date, actual_date)
...
def update_task(project_name, task_id, completed_date, projected_date=None, actual_date=None):
    ...
    try:
        ...
        expr_values = {
            ':status': 'completed' if (completed_date or actual_date) else 'not_started',
            ':taskData': task_data
        }
